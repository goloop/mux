...
RouterNoMiddleware-8   201ns ± 1%   182ns ± 2%   -9.45%  (p=0.008)
```

This shows your changes made the RouterNoMiddleware benchmark 9.45% faster, and this improvement is statistically significant.
